...
public class OutputPenerimaan extends javax.swing.JFrame {
String id;
    ...
    private void txtcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcetakActionPerformed
        // TODO add your handling code here:
         try {
          new OutputPenerimaan().printComponents(null);
          TextTampilan.print();
    ...
    try{
        ...
        ResultSet rs = DBHelper.selectQuery("SELECT * from Penerimaan WHERE noorder = '" +textId.getText()+ "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OutputPenerimaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
